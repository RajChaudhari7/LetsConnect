...
// find user using useranme, name, email, location
...
export const sendConnectionRequest = async (req, res) => {
    try {
        ...
        if (connectionRequests.length >= 20) {
            return res.json({ success: false, message: 'You have sent more than 20 connection requests in th last 24 hours' })
        }
        ...
        if (!connection) {
            ...
            res.json({ success: false, message: 'You are already connected with this person' })
        }
