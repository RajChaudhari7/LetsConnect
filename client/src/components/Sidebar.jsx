...
const Sidebar = ({ sidebarOpen, setSideBarOpen }) => {
    ...
    return (
        ...
        flex flex-col justify-between items-center max-sm:absolute top-0 bottom-0 z-20 ${sidebarOpen ? 'translate-x-0' : 'max-sm:-translate-x-full'}
        transition-all duration-300 ease-in-out`}>
            ...
            <div className='w-full border-t border-gray-200 p-4 px-7 flex items-ceenter justify-between'>
