        ...
        <div className='inline-flex flex-wrap items-center border border-gray-200 rounded-md p-1 bg-white shadow-sm'>
          {
            dataArray.map((tab) => (
              ...
              ${currentTab === tab.label ? 'bg-white font-medium text-black' : 'text-gray-5  hover:text-black'}`}
                key={tab.label}>
            ...
            <div className='w-full max-w-88 flex gap-5 p-6 bg-white shadow rounded-md' key={user._id}>
              ...
              <div className='flex-1'>
                ...
                <div className='flex max-sm:flex-col gap-2 mt-4'>
                  <button className='w-full p-2 text-sm rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition text-white cursor-pointer'
