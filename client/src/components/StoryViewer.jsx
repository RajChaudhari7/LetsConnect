...
const StoryViewer = ({ viewStory, setViewStory }) => {
    ...
    const renderContent = () => {
        switch (viewStory.media_type) {
            case 'image':
                return (
                    <img src={viewStory.media_url} className='max-w-full max-h-screen object-conatin'
                        alt="" />
                );
            case 'video':
                return (
                    <video controls autoPlay
                        src={viewStory.media_url} className='max-h-screen' onEnded={() => setViewStory(null)}
                    />
                );
